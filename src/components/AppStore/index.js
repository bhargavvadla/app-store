...
class AppStore extends Component {
  ...
  makeTabActive = uniqueId => {
    ...
    this.setState(prev => ({...prev, filteredAppsList: activeAppsList}))
  }
        ...
        <div className="app-store-container">
          ...
          <ul className="tabs-container">
            {tabsList.map(eachTab => (
              <TabItem
                tab={eachTab}
                updateActiveTab={this.makeTabActive}
                key={eachTab.tabId}
                activeStatus={activeTabId === eachTab.tabId && true}
              />
            ))}
          </ul>
          <ul className="apps-container">
            {activeAppsList.map(eachApp => (
